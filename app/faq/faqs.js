export const faqs = [
  ...
  {
    question: 'What information should I include in a quotation inquiry?',
    answer:
      'Include the catalogue family, requested specification, quantity, destination country or region, and any questions about packaging or batch-related documentation.',
  },
  {
    question: 'Where can I review the available specifications?',
    answer:
      'Start on the product catalogue page, then open the relevant product family page for a focused list of available specification options.',
  },
  {
    question: 'Can I ask about batch-related documentation before requesting a quote?',
    answer:
